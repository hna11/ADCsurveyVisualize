...
d3.csv('01/ENERGY/ISSCC/ISSCC.csv', function(data) { 
...
// *****************************************************************
    d3.csv('01/ENERGY/ISSCC/line.csv', function(line1) {
    var line = d3.line()
        .x(function(n) { return xScale(n.sndr)}) 
        .y(function(n) { return yScale(n.X1)}) 
    ...
    svg.append("path")
        ...
        var line2 = d3.line()
        .x(function(n) { return xScale(n.sndr)}) 
        .y(function(n) { return yScale(n.X2)}) 
        .curve(d3.curveMonotoneX)        
    svg.append("path")
        .datum(line1) 
        .attr("class", "line") 
...
svg.append('g')
    ...
    .attr("cy", function (d) { return yScale(d.fsnyq); } )
    .attr("r", 3)
    .attr("transform", "translate(" + 100 + "," + 100 + ")")
    .style("fill", "#18bcc2")
...
.on("mouseout", function(d) {
    ...
    .attr("y", function (dd) { return yScale(dd.fsnyq); } )
    .attr('width', 6)
    .attr('height', 6)
    .attr("transform", "translate(" + 100 + "," + 100 + ")")
    .style("fill", "red")
...
.on("mouseover", function(dd) {
        ...
        .attr("y", function (dd) { return yScale(dd.fsnyq)-2; } )
        .attr('width', 10)
        .attr('height', 10)
