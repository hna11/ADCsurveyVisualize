...
d3.csv('01/WaldemFomvsSpeed/ISSCC/ISSCC.csv', function(data) { 
    ...
    .text('WaldemFomvsSpeed ISSCC 1997-2021');
...
// *****************************************************************
    d3.csv('01/WaldemFomvsSpeed/ISSCC/line.csv', function(line1) {
    var line = d3.line()
...
svg.append('g')
    ...
    .attr("cy", function (d) { return yScale(d.FOMW_hf); } )
    .attr("r", 3)
    .attr("transform", "translate(" + 100 + "," + 100 + ")")
    .style("fill", "#2cb320")
...
.on("mouseout", function(d) {
    ...
    .attr("y", function (dd) { return yScale(dd.FOMW_hf); } )
    .attr('width', 6)
    .attr('height', 6)
    .attr("transform", "translate(" + 100 + "," + 100 + ")")
    .style("fill", "red")
...
.on("mouseover", function(dd) {
        ...
        .attr("y", function (dd) { return yScale(dd.FOMW_hf)-2; } )
        .attr('width', 10)
        .attr('height', 10)
