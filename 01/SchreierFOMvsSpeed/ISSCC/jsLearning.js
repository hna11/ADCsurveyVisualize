...
d3.csv('01/SchreierFOMvsSpeed/ISSCC/ISSCC.csv', function(data) { 
    ...
    .text('SchreierFOMvsSpeed ISSCC 1997-2021');
...
// *****************************************************************
    d3.csv('01/SchreierFOMvsSpeed/ISSCC/line.csv', function(line1) {
    var line = d3.line()
